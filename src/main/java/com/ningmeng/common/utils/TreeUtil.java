...
public class TreeUtil {
	...
	List<SysPermission> rootMenus;
	List<SysPermission> childMenus;
	
	public TreeUtil(List<SysPermission> rootMenus,List<SysPermission> childMenus){
		this.rootMenus = rootMenus;
		this.childMenus = childMenus;
	}  
	
//	public TreeUtil(List<SysPermission> rootMenus,List<SysPermission> childMenus,List<SysPermissionBtn> childBtns){
//		this.rootMenus = rootMenus;
//		this.childMenus = childMenus;
//	}  
	 ...
	 * @return
	 */
	private TreeNode MenuToNode(SysPermission menu){
		if(menu == null){
			return null;
		}
	 ...
	 * @return
	 */
	/*private TreeNode BtnToNode(SysPermissionBtn btn){
		if(btn == null){
			return null;
		}
		TreeNode node = new TreeNode();
	...
	private void addChlidNodes(TreeNode rootNode){
		...
		for(SysPermission menu : childMenus){
...
/*	private void addChlidBtn(TreeNode treeNode){
		List<TreeNode> childNodes = new ArrayList<TreeNode>(); 
		for(SysPermissionBtn btn : childBtns){
